...
export default function ChatPage() {
  ...
  const generateWelcomeBackMessage = (): void => {
    const inputMessage: string = "Generate a short WhatsApp‑style 'welcome back' message for me with three sections. " +
      ...
      "3. Then based on the retrieved data suggest 3-4 personalized follow-up questions section I could ask next. " +
      " - Suggest questions for both READ operations and WRITE operations. " +
